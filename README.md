...
[![Release](https://img.shields.io/badge/version-4.2.0-blue)](https://github.com/hatembenjaballah/karaf-metriques-bundle/releases)
...
1. **Cloner le dépôt** :
   ...
   ```
2. **Les features suivantes doivent être activées dans Karaf** :   
   ```shell
